...
export class CharactersController {
  ...
  @ApiOperation({
    ...
    description:
      "Retorna un personaje aleatorio de Rick and Morty, Pokémon o Superhéroes para ser evaluado",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Permite dar like o dislike a un personaje. Si es la primera vez que se evalúa, lo crea en la base de datos.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retorna el personaje más votado positivamente, más votado negativamente, último evaluado y totales",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Verifica si Pikachu ha sido evaluado y retorna sus estadísticas completas",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Retorna lista completa de personajes en la base de datos (útil para debugging)",
  })
  @ApiResponse({
    status: 200,
